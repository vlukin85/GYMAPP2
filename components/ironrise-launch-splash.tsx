...
const styles = StyleSheet.create({
  root: { ...StyleSheet.absoluteFillObject, zIndex: 10000, backgroundColor: "#160E24", justifyContent: "space-between", paddingHorizontal: 26, paddingVertical: 58 },
  image: { ...StyleSheet.absoluteFillObject, width: "100%", height: "100%", opacity: 0.86 },
  scrim: { ...StyleSheet.absoluteFillObject, backgroundColor: "#160E2478" },
  wordmark: { alignItems: "center", marginTop: 4 },
  name: { color: "#FBF8FF", fontSize: 34, lineHeight: 38, fontWeight: "900", letterSpacing: -1.4 },
  rise: { color: "#E83928" },
  tagline: { color: "#FBF8FF", fontSize: 8, fontWeight: "900", letterSpacing: 1.25, marginTop: 4 },
  loaderRow: { alignItems: "center", gap: 9 },
  loader: { width: 38, height: 3, backgroundColor: "#E83928" },
  loaderText: { color: "#FBF8FF", fontSize: 8, fontWeight: "900", letterSpacing: 1.1 },
});
