...
После push в `main` откройте **Actions** → **Android build** и скачайте `ironrise-debug-apk` из блока **Artifacts**. Он создаётся автоматически и хранится 14 дней. GitHub скачивает Artifact как **ZIP-архив**: распакуйте его в файловом менеджере, затем устанавливайте именно файл `app-debug.apk` из распакованной папки. Не переименовывайте ZIP в `.apk` и не открывайте архив как установочный пакет.
...
2. Распакуйте ZIP полностью и выберите `app-debug.apk`; у проверенной сборки от 21 августа 2026 года размер файла — около **109 МБ**, SHA-256: `9f7dacc403258e7db9ec453b4ee6c9b4c823de1277c97a892dce89e26cc87fdb`.
