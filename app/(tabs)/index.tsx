      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.heroGrid}>
          ...
          <View style={[styles.dayPanel, { borderColor: colors.border }]}>
            ...
            <Text style={[styles.wordmark, { color: colors.foreground }]}>IRON<Text style={{ color: colors.primary }}>RISE</Text></Text>
...
function WeekStrip({ now, scheduled, completed, colors }: { now: Date; scheduled: Record<string, unknown>; completed: Array<{ date: string }>; colors: any }) {
