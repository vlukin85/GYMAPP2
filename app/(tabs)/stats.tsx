...
const styles = StyleSheet.create({
  content: { paddingTop: 18, paddingBottom: 32, gap: 13 }, topRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }, settingsButton: { width: 42, height: 42, borderRadius: 5, alignItems: "center", justifyContent: "center" }, eyebrow: { fontSize: 11, fontWeight: "800", letterSpacing: 1.2 }, title: { fontSize: 30, fontWeight: "800", marginTop: 5 }, filters: { flexDirection: "row", borderRadius: 6, borderWidth: 1, padding: 4, gap: 3 }, filter: { minHeight: 35, borderRadius: 3, paddingHorizontal: 11, alignItems: "center", justifyContent: "center" }, filterText: { fontSize: 12, fontWeight: "800" }, dateForm: { borderWidth: 1, borderRadius: 6, padding: 12, gap: 8 }, dateLabel: { fontSize: 9, fontWeight: "900", letterSpacing: 0.7 }, calendarField: { minHeight: 45, borderWidth: 1, borderRadius: 4, paddingHorizontal: 12, flexDirection: "row", alignItems: "center", gap: 9 }, calendarFieldText: { flex: 1, fontSize: 14, fontWeight: "800" }, rangeCalendarFields: { flexDirection: "row", gap: 8 }, rangeCalendarField: { flex: 1, minHeight: 52, borderWidth: 1, borderRadius: 4, paddingHorizontal: 10, justifyContent: "center" }, rangeFieldCaption: { fontSize: 8, fontWeight: "900", letterSpacing: 0.6 }, rangeFieldValue: { fontSize: 11, fontWeight: "800", marginTop: 4 }, rangeHint: { fontSize: 10, lineHeight: 15 }, bigStats: { flexDirection: "row", gap: 8, marginTop: 4 }, bigCard: { flex: 1, minHeight: 109, borderWidth: 1, borderLeftWidth: 4, borderRadius: 5, padding: 13, justifyContent: "space-between" }, bigValue: { fontSize: 23, fontWeight: "800" }, bigLabel: { fontSize: 11 }, sectionRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginTop: 7 }, section: { fontSize: 19, fontWeight: "800" }, hint: { fontSize: 12, lineHeight: 18, marginTop: 3, maxWidth: 270 }, count: { fontSize: 16, fontWeight: "800", marginTop: 4 }, record: { minHeight: 69, borderRadius: 5, borderWidth: 1, padding: 11, flexDirection: "row", alignItems: "center", gap: 11 }, recordIcon: { width: 38, height: 38, borderRadius: 4, alignItems: "center", justifyContent: "center" }, recordName: { fontSize: 13, fontWeight: "800" }, recordGroup: { fontSize: 11, marginTop: 4 }, recordValueWrap: { alignItems: "flex-end", maxWidth: 104 }, recordValue: { textAlign: "right", fontSize: 12, fontWeight: "800" }, oneRm: { fontSize: 10, fontWeight: "800", marginTop: 4 }, empty: { borderWidth: 1, borderRadius: 6, padding: 20, alignItems: "center", gap: 8 }, emptyTitle: { fontSize: 14, fontWeight: "800", marginTop: 2 }, emptyText: { fontSize: 12, lineHeight: 17, textAlign: "center" }, backdrop: { flex: 1, backgroundColor: "#090611A8", justifyContent: "flex-end" }, calendarSheet: { borderTopLeftRadius: 12, borderTopRightRadius: 12, padding: 20, gap: 13 }, pickerHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }, pickerTitle: { fontSize: 20, fontWeight: "900" }, pickerSubtitle: { fontSize: 11, marginTop: 4 }, pickerClose: { width: 36, height: 36, borderRadius: 5, justifyContent: "center", alignItems: "center" }, pickerCloseText: { fontSize: 25, lineHeight: 28 }, pickerMonth: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 2 }, pickerMonthText: { fontSize: 16, fontWeight: "900", textTransform: "capitalize" }, weekdays: { flexDirection: "row" }, weekday: { width: "14.285%", textAlign: "center", fontSize: 10, fontWeight: "900" }, calendarGrid: { flexDirection: "row", flexWrap: "wrap" }, calendarDay: { width: "14.285%", height: 43, borderRadius: 4, alignItems: "center", justifyContent: "center" },
