...
export default function ProgramsScreen() {
  ...
  const renderProgramCard = (program: WorkoutProgram) => {
    ...
    return <View key={program.id} style={[styles.card, { backgroundColor: colors.surface, borderColor: isSelected ? colors.primary : colors.border, borderRadius: 22, paddingLeft: 15, opacity: isArchived ? 0.82 : 1 }]}>
...
const styles = StyleSheet.create({ content: { paddingTop: 18, paddingBottom: 32, gap: 14 }, header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, eyebrow: { fontSize: 11, fontWeight: "800", letterSpacing: 1.2 }, title: { fontSize: 30, fontWeight: "800", marginTop: 5 }, subtitle: { fontSize: 14, lineHeight: 20, marginBottom: 4 }, add: { width: 43, height: 43, borderRadius: 5, alignItems: "center", justifyContent: "center" }, plus: { fontSize: 25, color: "#101412", lineHeight: 28 }, aiCard: { borderRadius: 6, borderLeftWidth: 7, borderLeftColor: "#E24A3B", padding: 17, minHeight: 113, flexDirection: "row", alignItems: "center", gap: 12 }, aiEyebrow: { color: "#101412AA", fontSize: 10, fontWeight: "900", letterSpacing: 1 }, aiTitle: { color: "#101412", fontSize: 18, fontWeight: "900", marginTop: 4 }, aiText: { color: "#101412CC", fontSize: 11, lineHeight: 16, marginTop: 5 }, aiArrow: { color: "#101412", fontSize: 35, fontWeight: "400" }, transferRow: { flexDirection: "row", gap: 6, flexWrap: "wrap" }, transferButton: { flexGrow: 1, minWidth: "40%", minHeight: 43, borderRadius: 5, borderWidth: 1, alignItems: "center", justifyContent: "center", paddingHorizontal: 8 }, transferText: { fontSize: 11, fontWeight: "900" }, selectionBar: { minHeight: 46, borderRadius: 5, borderWidth: 1, paddingHorizontal: 13, flexDirection: "row", alignItems: "center", gap: 16 }, selectionText: { flex: 1, fontSize: 12, fontWeight: "900" }, selectionAction: { fontSize: 12, fontWeight: "900" }, archiveToggle: { minHeight: 47, borderRadius: 5, borderWidth: 1, paddingHorizontal: 14, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }, archiveToggleText: { fontSize: 13, fontWeight: "900" }, archiveToggleArrow: { fontSize: 24 }, archiveTitle: { fontSize: 18, fontWeight: "900", marginTop: 2 }, searchInput: { minHeight: 47, borderWidth: 1, borderRadius: 5, paddingHorizontal: 13, fontSize: 13, fontWeight: "700" }, card: { borderRadius: 6, borderWidth: 1, padding: 15, paddingLeft: 19, overflow: "hidden", position: "relative" }, cardAccent: { position: "absolute", left: 0, top: 0, bottom: 0, width: 5 }, cardHeader: { flexDirection: "row", alignItems: "center", gap: 11 }, programIcon: { width: 42, height: 42, borderRadius: 5, alignItems: "center", justifyContent: "center" }, cardTitle: { fontSize: 16, fontWeight: "800" }, cardSub: { fontSize: 12, marginTop: 4 }, createdAt: { fontSize: 10, fontWeight: "700", marginTop: 6 }, cardActions: { alignItems: "flex-end", gap: 7 }, rename: { fontSize: 10, fontWeight: "900" }, renameSecondary: { fontSize: 9, fontWeight: "800" }, check: { height: 24, width: 24, borderRadius: 4, borderWidth: 1, alignItems: "center", justifyContent: "center" }, checkText: { fontSize: 15, fontWeight: "900" }, divider: { height: 1, marginVertical: 13 }, exerciseLine: { fontSize: 12, lineHeight: 18 }, managementRow: { flexDirection: "row", gap: 18, marginTop: 12 }, managementAction: { fontSize: 11, fontWeight: "900" }, cardFooter: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 15 }, meta: { fontSize: 11 }, start: { borderRadius: 4, paddingHorizontal: 14, paddingVertical: 9 }, startText: { fontSize: 12, color: "#101412", fontWeight: "800" }, archivedLabel: { fontSize: 11, fontWeight: "800" }, emptyArchive: { borderRadius: 6, borderWidth: 1, padding: 18 }, emptyArchiveTitle: { fontSize: 15, fontWeight: "900" }, emptyArchiveText: { fontSize: 12, lineHeight: 18, marginTop: 5 }, newCard: { borderRadius: 6, borderWidth: 1, borderStyle: "dashed", padding: 18 }, newTitle: { fontSize: 15, fontWeight: "800" }, newSub: { fontSize: 12, marginTop: 6 }, undoToast: { position: "absolute", left: 14, right: 14, bottom: 74, minHeight: 68, borderRadius: 7, borderWidth: 1, padding: 11, flexDirection: "row", alignItems: "center", gap: 10, elevation: 12, shadowColor: "#000000", shadowOpacity: 0.25, shadowRadius: 12, shadowOffset: { width: 0, height: 6 } }, undoToastTitle: { fontSize: 12, fontWeight: "900" }, undoToastHint: { fontSize: 10, marginTop: 3 }, undoAction: { minHeight: 40, paddingHorizontal: 13, borderRadius: 5, justifyContent: "center", alignItems: "center" }, undoActionText: { color: "#101412", fontSize: 11, fontWeight: "900" }, modalBackdrop: { flex: 1, backgroundColor: "#1E1230AA", justifyContent: "flex-end", padding: 16 }, renameSheet: { borderWidth: 1, borderRadius: 8, padding: 18, gap: 10 }, renameEyebrow: { fontSize: 10, fontWeight: "900", letterSpacing: 1 }, renameTitle: { fontSize: 23, fontWeight: "900" }, nameInput: { minHeight: 50, borderWidth: 1, borderRadius: 5, paddingHorizontal: 13, fontSize: 15, fontWeight: "800", marginTop: 3 }, renameActions: { flexDirection: "row", gap: 10, marginTop: 4 }, cancel: { flex: 1, minHeight: 47, borderWidth: 1, borderRadius: 5, alignItems: "center", justifyContent: "center" }, cancelText: { fontSize: 13, fontWeight: "900" }, save: { flex: 1, minHeight: 47, borderRadius: 5, alignItems: "center", justifyContent: "center" }, saveText: { color: "#101412", fontSize: 13, fontWeight: "900" } });
