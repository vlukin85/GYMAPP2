...
export default function ProgramsScreen() {
  ...
  const renderProgramCard = (program: WorkoutProgram) => {
    ...
    return <View key={program.id} style={[styles.card, { backgroundColor: colors.surface, borderColor: isSelected ? colors.primary : colors.border, opacity: isArchived ? 0.82 : 1 }]}><View style={[styles.cardAccent, { backgroundColor: colors.primary }]} />
