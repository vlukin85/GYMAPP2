...
export default function WorkoutHistoryScreen() {
  ...
  const { completed, programs, deleteCompletedWorkout } = useWorkoutStore();
  ...
  const deleteWorkout = () => {
    Alert.alert(
      ...
      "Запись исчезнет из истории и календаря. Статистика и личные рекорды будут пересчитаны по оставшимся тренировкам.",
      [
